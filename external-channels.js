...
const EXTERNAL_AUTHORITIES = [
  ...
  { name: 'Boverket', areas: ['productSafety'], url: 'https://www.boverket.se/sv/om-boverket/visselblasning/' },
  { name: 'Ekobrottsmyndigheten', areas: ['euFraud'], url: 'https://www.ekobrottsmyndigheten.se/visselblasarfunktion-eu-medel/' },
  ...
  { name: 'Fastighetsmäklarinspektionen', areas: ['finance'], url: 'https://fmi.se/det-har-ar-fmi/kontakta-oss/visselblasning-om-penningtvatt/' },
  { name: 'Finansinspektionen', areas: ['finance', 'consumer', 'privacy'], url: 'https://www.fi.se/sv/om-fi/kontakta-oss/visselblasare/' },
  { name: 'Folkhälsomyndigheten', areas: ['productSafety', 'publicHealth'], url: 'https://www.folkhalsomyndigheten.se/livsvillkor-levnadsvanor/andts/regler-for-tillverkning-handel-och-hantering/visselblasning-tobaksomradet/' },
  ...
  { name: 'Skogsstyrelsen', areas: ['environment'], url: 'https://www.skogsstyrelsen.se/kontakt/visselblasarfunktion/' },
  { name: 'Spelinspektionen', areas: ['finance'], url: 'https://www.spelinspektionen.se/lagar--forordningar/penningtvatt/visselblasarfunktion/' },
  ...
  { name: 'Statens jordbruksverk', areas: ['environment', 'food', 'productSafety'], url: 'https://jordbruksverket.se/e-tjanster-databaser-och-appar/ovriga-e-tjanster-och-databaser/anmal-offentliga-kontroller-visselblasarfunktion' },
